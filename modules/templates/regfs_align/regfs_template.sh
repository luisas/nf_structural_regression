...
t_coffee -reg -seq input.fa -nseq $bucket_size -reg_tree tree.dnd -method method.txt -quickcompact -outfile ${id}.foldeek_regressive_new.${bucket_size}.${library_method}.${tree_method}.aln
